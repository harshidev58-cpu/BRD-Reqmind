...
import DataSourcesReal from './pages/DataSourcesReal'
import Processing from './pages/Processing'
import AlignmentIntelligence from './pages/AlignmentIntelligence'
import BRDGeneratorAutonomous from './pages/BRDGeneratorAutonomous'
        ...
        <div className="main-content">
          ...
          <div className="page-content">
            <Routes>
              ...
              <Route path="/data-sources" element={<DataSourcesReal />} />
              <Route path="/processing" element={<Processing />} />
              <Route path="/alignment" element={<AlignmentIntelligence />} />
              <Route path="/brd-generator" element={<BRDGeneratorAutonomous />} />
